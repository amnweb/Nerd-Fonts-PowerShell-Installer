...
$fontsList = "https://raw.githubusercontent.com/amnweb/nf-installer/main/fonts.txt"
$fontsVers = "3.1.1"
...
if (Test-Path $fontsList) {
    [void]$CheckListBox.Items.Add("Select All")
    Get-Content $fontsList | Sort-Object | ForEach-Object {
        [void]$CheckListBox.Items.Add($_)
    }
} else {
